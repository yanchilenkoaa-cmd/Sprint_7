...
public class OrderRequestWithoutColor {
    ...
    public OrderRequestWithoutColor() {
        // Конструктор по умолчанию
    }

    public OrderRequestWithoutColor(String firstName, String lastName, String address, int metroStation,
